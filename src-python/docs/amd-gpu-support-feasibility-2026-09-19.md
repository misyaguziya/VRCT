...
> **2026-09-20 追記 — この数字も不足していた。**
> ROCm 版の `ctranslate2.dll` は **277MB** で、CPU/CUDA 版の 58MB より
> 219MB 大きい (gfx カーネルが DLL の中に入っているため)。上の表は
> 「外から足す ROCm ランタイム」しか数えておらず、この差を含んでいない。
> **改訂後: CPU 版 + 約 500〜530MB。**
> 実測の詳細は `amd-gpu-support-design-2026-09-19.md` §10.5。
